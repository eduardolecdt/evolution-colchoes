(function (){
  ...
  const section = document.querySelector('section[name="quadros3"]')
  ...
  function abrirModal1 () {
    ...
    imgAbrir1.addEventListener('click', () => {
      modal1.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function abrirModal2 () {
    ...
    imgAbrir2.addEventListener('click', () => {
      modal2.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function abrirModal3 () {
    ...
    imgAbrir3.addEventListener('click', () => {
      modal3.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function abrirModal4 () {
    ...
    imgAbrir4.addEventListener('click', () => {
      modal4.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function abrirModal5 () {
    ...
    imgAbrir5.addEventListener('click', () => {
      modal5.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function abrirModal6 () {
    ...
    imgAbrir6.addEventListener('click', () => {
      modal6.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function fecharModal6 () {
    fechar6.addEventListener('click', () => {
      modal6.classList.remove('mostrar')
      body.classList.remove('bloqueado')
    })
  }
  ...
  function abrirModal7 () {
    ...
    imgAbrir7.addEventListener('click', () => {
      modal7.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function fecharModal7 () {
    fechar7.addEventListener('click', () => {
      modal7.classList.remove('mostrar')
      body.classList.remove('bloqueado')
    })
  }
  ...
  function abrirModal8 () {
    ...
    imgAbrir8.addEventListener('click', () => {
      modal8.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function fecharModal8 () {
    fechar8.addEventListener('click', () => {
      modal8.classList.remove('mostrar')
      body.classList.remove('bloqueado')
    })
  }
  ...
  function abrirModal9 () {
    ...
    imgAbrir9.addEventListener('click', () => {
      modal9.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function fecharModal9 () {
    fechar9.addEventListener('click', () => {
      modal9.classList.remove('mostrar')
      body.classList.remove('bloqueado')
    })
  }
  ...
  function abrirModal10 () {
    ...
    imgAbrir10.addEventListener('click', () => {
      modal10.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function fecharModal10 () {
    fechar10.addEventListener('click', () => {
      modal10.classList.remove('mostrar')
      body.classList.remove('bloqueado')
    })
  }
  ...
  function abrirModal11 () {
    ...
    imgAbrir11.addEventListener('click', () => {
      modal11.classList.add('mostrar')
      body.classList.add('bloqueado')
    })
  }
  ...
  function fecharModal11 () {
    fechar11.addEventListener('click', () => {
      modal11.classList.remove('mostrar')
      body.classList.remove('bloqueado')
    })
  }
  ...
  function abrirModal12 () {
    h2Abrir12.addEventListener('click', () => {
  ...
  function fecharModal12 () {
    fechar12.addEventListener('click', () => {
      modal12.classList.remove('mostrar')
      body.classList.remove('bloqueado')
    })
  }
